...
namespace BloomPostprocess
{
    public class BloomComponent : DrawableGameComponent
    {
        ...
        private static BloomSettings settings = new BloomSettings("Ble", 0.15f, 3f, 1.05f, 1.1f, 1.6f, 1.25f);
        //BloomSettings settings = new BloomSettings("Ble", 0.15f, 0, 0f, 1f, 1.0f, 1.0f);
        ...
        protected override void LoadContent()
        {
            ...
            resolveTarget = new RenderTarget2D(GraphicsDevice, width, height, false, format, DepthFormat.Depth24, 1, RenderTargetUsage.DiscardContents);
